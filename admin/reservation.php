...
<title>Jumping Fitness Malaysia | Student's Reservation</title>
   ...
   <div class="right_col" role="main" style="min-height: 1154px;">
    <div class="">
        <div class="">
            	...
            	<h4 style="size:40px; color:#21991E; font-weight:bold"><i class=" fa fa-"></i> Reservation </h4>
...
public function get_reservation($lmt){
		 try{
		 $qry = "SELECT a.id, b.cname, b.begin_date, b.begin_time, b.time, a.amount, c.fname, c.email, c.phone FROM reservation a INNER JOIN class b ON a.class_id = b.id INNER join profile c ON a.member_id = c.id  ORDER BY id DESC LIMIT ?, 50";
		 $stmt = $this->pdc->prepare($qry);
