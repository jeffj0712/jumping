   ...
   <div class="right_col" role="main" style="min-height: 1154px;">
    <div class="">
        <div class="">
            	...
            	<h4 style="size:40px; color:#21991E; font-weight:bold"><i class=" fa fa-lock"></i> Admin | Change Password </h4>
          ...
          <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                         <form onSubmit="change_password(event)">
                                          ...
                                          <div class="form-group">
                                              <label for="inputText2"  class="col-form-label">Retype Password</label>
