...
$recover_link = "https://www.jumpingfitness.com/password_recovery.php?pl=$ref&n=0";
...
$mail->AltBody = "Please click on the link below to recover your password /n/n $recover_link";
...
class mypdo{
	 ...
	 public function __construct(){
	  ...
	  public function get_profile($ch, $data){
		  if($ch == 0)
		 $qry = "SELECT email, fname FROM profile WHERE username = ?";
		 else
		$qry = "SELECT email, fname FROM profile WHERE email = ?"; 
