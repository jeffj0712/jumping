...
<html class=" " lang="en">
	<head>
		...
		<div class="right_col" role="main" style="min-height: 1154px;">
			<div style="text-align:right"><a class="btn btn-primary fa fa-mail-reply" href="class_reservation.php"> Back to List View</a></div>
			<div class="">
				<div class="">
					<h4 style="size:40px; color:#21991E; font-weight:bold; text-align: center; "><i class=" fa fa-bicycl"></i> Class Calender </h4>
				</div>
