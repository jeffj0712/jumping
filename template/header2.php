...
<div class="container body">
    <div class="main_container">
            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile">
                    <div class="profile_pic">
                        <img src="../assets/profile/<?php echo $_SESSION['p']; ?>.jpg" style="max-width:30px;" alt="..." class="img-circle profile_img">
                    </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu ">
                    <div class="menu_section">
                        ...
                        <li><a href="./class_reservation.php"><i class="fa fa-pl"></i>View Classes</a>
                    </li>
                    <li><a href="./my_reservation.php"><i class="fa fa-plu"></i>My Reservation</a>
                </li>
        ...
        <li><a href="./transaction.php"><i class="fa fa-plu"></i>Transaction Records</a></li>
...
<ul class="nav navbar-nav navbar-right">
    <li class="">
        <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            <img src="../assets/profile/<?php echo $_SESSION['p']; ?>.jpg"  alt=""><?php echo $_SESSION['username']; ?>  <span class=" fa fa-angle-down"></span>
        </a>
